...
def build_train_val_set(batch_size, ds_builder,key, percentage_to_keep,validation_split_percentage=10, total_training_samples=60000):
...
def build_full_train(ds_builder, key, percentage_to_keep,total_training_samples=60000):
  """Builds train dataset."""
...
def build_full_train_with_val(ds_builder, key, percentage_to_keep, validation_split_percentage=10, total_training_samples=60000): 
  """
...
def build_complementary_test_set(ds_builder, key, percentage_to_keep,total_training_samples=60000):
